...
### Install Subo: the SE2 CLI[](#install-subo-the-se2-cli "Direct link to heading")
...
## Start SE2 locally[](#start-se2-locally "Direct link to heading")
...
## Meet the editor[](#meet-the-editor "Direct link to heading")
