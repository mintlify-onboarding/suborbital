---
title: "The plugin editor" 
description: "The SE2 code editor is available for you to embed in your application, so your users can build their plugins quickly and easily"
---

<img src = "/images/editor-screen-35b2739bd6f6940c24601e08ffa3f8fa.png" />
...
The plugin namespace (if not included, the default namespace is used, see [Namespaces](/how-to/plugins/namespaces) for more details)

**Template** (optional): `&template=assemblyscript`

The language template used for new plugins. Check out our [supported languages](/reference/language-support)!
